...
@section('title', 'Disponibilités - ANADEC RH')
@section('page-title', 'Disponibilités')
@section('page-description', 'Liste des agents en disponibilité')
...
<div class="space-y-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-gray-600">Agents en disponibilité</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border">
        <form method="GET" class="flex items-center space-x-4">
            ...
            @if(request('search'))
                <a href="{{ route('agents.disponibilites') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date de Disponibilité</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $agent->date_disponibilite ? $agent->date_disponibilite->format('d/m/Y') : '-' }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            @if($agent->date_disponibilite)
                                {{ $agent->date_disponibilite->diffInDays(now()) }} jours
                            @else
                                -
                            @endif
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                            Aucun agent en disponibilité trouvé.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
