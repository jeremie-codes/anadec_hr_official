...
@section('page-title', 'Mes Demandes de Véhicule')
@section('page-description', 'Suivi de vos demandes de Véhicule')
                ...
                <a href="{{ route('demandes-vehicules.create') }}"
                   class="group flex items-center p-4 bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl hover:from-green-100 hover:to-emerald-200 transition-all duration-200 border border-green-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-green-700">Créer une demande de véhicule</p>
                    </div>
                </a>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900 max-w-xs">
                                {{ $demande->date_heure_sortie ->format('d/m/Y') }}
                            </div>
                            @if($demande->date_heure_sortie )
                                <div class="text-xs text-gray-500 mt-1">
                                    Souhaité le {{ $demande->date_heure_sortie ->format('d/m/Y') }}
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-8 text-center text-gray-500">
                            ...
                            <p>Aucune demande de véhicule trouvée.</p>
                            <a href="{{ route('demandes-vehicules.create') }}"
