...
@section('title', 'Approbation Demandes Véhicules - ANADEC RH')
@section('page-title', 'Approbation des Demandes de Véhicules')
@section('page-description', 'Interface d\'approbation des demandes de véhicules')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-indigo-600 p-6 rounded-xl shadow-lg border border-blue-200">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-3xl font-bold text-white">{{ \App\Models\DemandeVehicule::approuve()->count() }}</p>
        ...
        <div class="bg-gradient-to-br from-red-500 to-rose-600 p-6 rounded-xl shadow-lg border border-red-200">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-3xl font-bold text-white">{{ \App\Models\DemandeVehicule::rejete()->count() }}</p>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-red-600 p-6 rounded-xl shadow-lg border border-orange-200">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-3xl font-bold text-white">{{ \App\Models\DemandeVehicule::urgent()->enAttente()->count() }}</p>
        ...
        <form method="GET" class="flex items-center space-x-4">
            <div class="relative flex-1">
                <input type="text" name="search" value="{{ request('search') }}"
                       placeholder="Rechercher par nom d'agent ou destination..."
            ...
            @if(request('search'))
                <a href="{{ route('demandes-vehicules.approbation') }}" class="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-4 py-2 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all">
