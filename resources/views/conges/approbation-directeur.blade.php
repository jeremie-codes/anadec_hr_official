...
@section('title', 'Approbation Directeur - ANADEC RH')
@section('page-title', 'Approbation Directeur')
@section('page-description', 'Interface d\'approbation des demandes de congé par le directeur')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-gradient-to-br from-yellow-500 to-orange-600 p-6 rounded-xl shadow-lg border border-yellow-200">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-yellow-100">Demandes en attente</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-blue-500 to-indigo-600 p-6 rounded-xl shadow-lg border border-blue-200">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-3xl font-bold text-white">{{ \App\Models\Conge::approuveDirecteur()->count() }}</p>
                    <p class="text-sm text-blue-100">Déjà approuvées</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-red-500 to-rose-600 p-6 rounded-xl shadow-lg border border-red-200">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-3xl font-bold text-white">{{ \App\Models\Conge::rejete()->count() }}</p>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
        <form method="GET" class="flex items-center space-x-4">
            ...
            @if(request('search'))
                <a href="{{ route('conges.approbation-directeur') }}" class="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-4 py-2 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all">
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex-shrink-0 ml-6">
                        <div class="flex space-x-3">
                            <!-- Bouton Approuver -->
                            <button onclick="openApprovalModal({{ $conge->id }}, 'approuver')"
                            ...
                            <!-- Bouton Rejeter -->
                            <button onclick="openApprovalModal({{ $conge->id }}, 'rejeter')"
...
<script>
function openApprovalModal(congeId, action) {
    ...
    form.action = `/conges/${congeId}/approuver-directeur`;
