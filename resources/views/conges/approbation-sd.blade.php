...
@section('page-title', 'Approbation Sous Directeur')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-indigo-600 p-6 rounded-xl shadow-lg border border-blue-200">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-3xl font-bold text-white">{{ \App\Models\Conge::approuveSousDirecteur()->count() }}</p>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
        <form method="GET" class="flex items-center space-x-4">
            ...
            @if(request('search'))
                <a href="{{ route('conges.approbation-sd') }}" class="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-4 py-2 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all">
...
function openApprovalModal(congeId, action) {
    ...
    form.action = `/conges/${congeId}/approuver-sd`;
